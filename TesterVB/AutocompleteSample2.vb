...
Public Class AutocompleteSample2
    ...
    Private keywords As String() = {"abstract", "as", "base", "bool", "break", "byte",
    ...
    Private declarationSnippets As String() = {"public class ^" & vbLf & "{" & vbLf & "}", "private class ^" & vbLf & "{" & vbLf & "}", "internal class ^" & vbLf & "{" & vbLf & "}", "public struct ^" & vbLf & "{" & vbLf & ";" & vbLf & "}", "private struct ^" & vbLf & "{" & vbLf & ";" & vbLf & "}", "internal struct ^" & vbLf & "{" & vbLf & ";" & vbLf & "}",
    ...
    Private Class InsertEnterSnippet
        ...
        Public Overrides Function GetTextForReplace() As String
            'extend range
            Dim r As FastColoredTextBoxNS.Range = Parent.Fragment
